...
# Args
# -------------------------
parser = argparse.ArgumentParser(description="BreakFlow FFNO Trainer")
...
parser.add_argument("--per_data_generation_time", type=float, default=180.0,
                    help="Time to generate one training sample (seconds).")
...
per_step_time = 0.41
per_data_generation_time = float(args.per_data_generation_time)
