...
for NDATA in "${ndatas[@]}"; do
  python train.py \
    ...
    trainer.prediction_type=delta data=ks_exponax trainer.max_epoch=10000 data_workers=10 model.override_dimensionality=0 auto_resume=True \
    ...
    ++trainer.gen_time_s=0.06673403584957123 \
