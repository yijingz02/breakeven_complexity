...
### Custom NPY datasets
name = 'custom_ns64_t10'
DATASET_DICT[name] = {
	'train_path': 'data/navier_stokes',
	'test_path': 'data/navier_stokes',
	'storage_format': 'npy',
	'train_files': {'u': ['data_0_u.npy']},
	'test_files': {'u': ['data_val_u.npy']},
	'channel_keys': ['u']
}
DATASET_DICT[name]['train_size'] = 20000
DATASET_DICT[name]['test_size'] = 1000
DATASET_DICT[name]['scatter_storage'] = False
DATASET_DICT[name]['t_test'] = 5
DATASET_DICT[name]['t_in'] = 5
DATASET_DICT[name]['t_total'] = 10
DATASET_DICT[name]['in_size'] = (64, 64)
DATASET_DICT[name]['n_channels'] = 1
DATASET_DICT[name]['downsample'] = (1, 1)


name = 'custom_ks64_t50'
DATASET_DICT[name] = {
	'train_path': 'data/kuramoto_sivashinsky',
	'test_path': 'data/kuramoto_sivashinsky',
	'storage_format': 'npy',
	'train_files': {'u': ['data_0_u.npy']},
	'test_files': {'u': ['data_val_u.npy']},
	'channel_keys': ['u']
...
name = 'custom_gs64_t200'
DATASET_DICT[name] = {
	'train_path': 'data/gray_scott',
	'test_path': 'data/gray_scott',
	'storage_format': 'npy',
	'train_files': {
		'u': [f'data_{i}_u.npy' for i in range(10)],
		'v': [f'data_{i}_v.npy' for i in range(10)]
	},
	'test_files': {
		'u': ['data_val_u.npy'],
		'v': ['data_val_v.npy']
...
DATASET_DICT[name]['test_size'] = 1000
DATASET_DICT[name]['scatter_storage'] = False
DATASET_DICT[name]['t_test'] = 190
DATASET_DICT[name]['t_in'] = 10
DATASET_DICT[name]['t_total'] = 200
DATASET_DICT[name]['in_size'] = (64, 64)
DATASET_DICT[name]['n_channels'] = 2
DATASET_DICT[name]['downsample'] = (1, 1)

name = 'custom_bf64_t40'
DATASET_DICT[name] = {
	'train_path': 'data/breakflow',
	'test_path': 'data/breakflow',
	'storage_format': 'npy',
	'train_files': {
		'velocity_x': ['data_0_velocity_x.npy'],
		'velocity_y': ['data_0_velocity_y.npy'],
		'pressure': ['data_0_pressure.npy']
	},
	'test_files': {
		'velocity_x': ['data_test_velocity_x.npy'],
		'velocity_y': ['data_test_velocity_y.npy'],
		'pressure': ['data_test_pressure.npy']
	},
	'channel_keys': ['velocity_x', 'velocity_y', 'pressure'],
	'train_mask_files': ['data_0_mask.npy'],
	'test_mask_files': ['data_test_mask.npy']
}
DATASET_DICT[name]['train_size'] = 2000
DATASET_DICT[name]['test_size'] = 50
DATASET_DICT[name]['scatter_storage'] = False
DATASET_DICT[name]['t_test'] = 35
DATASET_DICT[name]['t_in'] = 5
DATASET_DICT[name]['t_total'] = 40
DATASET_DICT[name]['in_size'] = (64, 64)
DATASET_DICT[name]['n_channels'] = 3
DATASET_DICT[name]['downsample'] = (1, 1)
